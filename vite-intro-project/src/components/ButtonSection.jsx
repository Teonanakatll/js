...
export default function ButtonSection() {
 // всегда обьявляется внутри компонента и находится на верхнем уровне, никаких условий не допускается при обьявлении стейтов
  ...
  function handleClick(type) {
    ...
    // переменная всего лиш является ключом с помощю которого из какого то обьекта в зависимости от его значения берутся различные данные?
    setContentType(type)
  }
  ...
  if (contentType) {
	...
	return (
		<section>
			...
			*/}</p>
			<Button isAct={contentType === 'way'} onPress={() => handleClick('way')}>Подход</Button>
			<Button isAct={contentType === 'easy'} onPress={() => handleClick('easy')}>Доступность</Button>
			<Button isAct={contentType === 'program'} onPress={() => handleClick('program')}>Концентрация</Button>
